...
import { difficultyColor, retentionColor, toPercent, toFixed } from '../utils/format.js';
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.twoCol}>
        ...
        >
          <MiniDistribution buckets={ov.combinedBuckets} />
        </SectionCard>

        <SectionCard
          title="Student retention"
          sub="% of GA1 cohort submitting each assignment"
        >
          {retention.map(r => (
            <BarRow
              key={r.assignment}
